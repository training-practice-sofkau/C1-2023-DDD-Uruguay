...
import { CustomerEmailChangedEventPublisherBase } from '../../../domain/events/publishers';
import { IEventPublisher } from '@sofka';
import { CustomerEntity } from '../../persistence/entities/customer.entity';


export class CustomerEmailChangedPublisher extends CustomerEmailChangedEventPublisherBase{
