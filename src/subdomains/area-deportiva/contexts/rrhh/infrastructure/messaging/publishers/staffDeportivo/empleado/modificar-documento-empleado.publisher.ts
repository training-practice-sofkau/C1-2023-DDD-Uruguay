...
import { DocumentoModificadoEventPublisher } from '../../../../../domain/events/publishers/empleado/documento-modificado.event-publisher';



@Injectable()
export class  ModificarDocumentoEmpleadoPublisher extends DocumentoModificadoEventPublisher {
