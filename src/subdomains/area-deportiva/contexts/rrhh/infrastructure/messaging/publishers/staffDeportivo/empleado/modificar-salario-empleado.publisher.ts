...
import { SalarioModificadoEventPublisher } from 'src/subdomains/area-deportiva/contexts/rrhh/domain/events/publishers';



@Injectable()
export class  ModificarSalarioEmpleadoPublisher extends SalarioModificadoEventPublisher {
