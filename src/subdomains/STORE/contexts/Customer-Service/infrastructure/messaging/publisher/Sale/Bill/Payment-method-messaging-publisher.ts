...
import { PaymentMethodEventPublisher } from "src/subdomains/Store/contexts/Customer-Service/domain/events/publishers/Sale";

export class IPaymentMethodEventPublisher extends PaymentMethodEventPublisher {
